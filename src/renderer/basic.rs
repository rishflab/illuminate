...
pub struct BasicPathtracer<B: Backend> {
...
impl <B: Backend>Renderer<B> for BasicPathtracer<B> {

    unsafe fn new(mut backend: BackendState<B>, window: WindowState, scene: &Scene) -> Self {
...
impl<B: Backend> BasicPathtracer<B> {
